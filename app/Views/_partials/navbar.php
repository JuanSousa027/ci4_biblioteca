<nav class="navbar navbar-expand-lg bg-dark mb-3">
  <div class="container">
    <b><?=anchor("Aluno/index","Biblioteca",['class' => 'navbar-brand link-secondary text-light'])?></b>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
        <?=anchor("Usuario/index","Usuário",['class' => 'nav-link active link-secondary text-light'])?>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <?=anchor("Emprestimo/index","Empréstimo",['class' => 'nav-link active link-secondary text-light', 'aria-current'=>'page',])?>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link active link-secondary text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
